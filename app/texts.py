...
TEXT_MESSAGES = {
    "ru": {
        ...
        "main_menu": (
            ...
            "Жми на <b>Проверить наличие доступа</b>, чтобы узнать, есть ли у тебя доступ :)\n\n"
    ...
    "en": {
        ...
        "select_language": (
            f"{hide_link('hhttp://regiton.net/wp-content/uploads/2024/04/Resistance-Girl-Logo.png')}"
            "👋 <b>Hello!</b>\n\n"
            "Choose a language:"
        ),
        "change_language": (
